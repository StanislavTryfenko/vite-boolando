...
<template>
    <main>
        <div class="case" v-for="(product, index) in products" :key="product.id">
            ...
            <h5>
                <span class="discounted-price" v-if="product.badges.find(badge => badge.type === 'discount')">{{discountedPrice(product)}} &euro; </span>
